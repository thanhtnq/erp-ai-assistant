...
const MODELS = {
  ...
  purchase: {
    table:           'scm_pur_main',
    masterfn_field:  'masterfn',
    companyfn_field: 'companyfn',
    pk:              'uniquenum_pri',
    default_filters: { tag_void_yn: 'n' },
    select_cols: [
      'uniquenum_pri', 'dnum_auto', 'dnum_reference', 'date_trans', 'date_due',
      'party_code', 'party_desc', 'party_unique',
      'amount_forex', 'amount_local', 'curr_short_forex', 'curr_rate_forex_f_calc',
    ...
    text_search:    new Set(['party_desc', 'dnum_auto', 'dnum_reference', 'staff_desc']),
    date_field:     'date_trans',
    amount_field:   'amount_local',
    allowed_filters: new Set([
      'party_code', 'party_desc', 'date_trans', 'date_from', 'date_to',
  ...
  stock: {
    ...
    default_filters: { tag_void_yn: 'n' },
    select_cols: [
      'uniquenum_pri', 'dnum_auto', 'dnum_reference', 'date_trans',
      'tag_table_usage', 'tag_void_yn',
      'location_code',
      'stkcode_code', 'stkcode_unique',
      'balance_qnty_uom_stk_code',
      'party_code', 'party_desc', 'party_unique',
      'staff_code', 'staff_unique',
      'amount_local', 'amount_forex', 'curr_short_forex',
      'companyfn',
    ],
    text_search:    new Set(['party_desc', 'dnum_auto', 'dnum_reference']),
    date_field:     'date_trans',
    amount_field:   'amount_local',
    allowed_filters: new Set([
      'party_code', 'party_desc', 'date_trans', 'date_from', 'date_to',
      'staff_code', 'dnum_auto', 'dnum_reference',
      'stkcode_code', 'location_code',
      'curr_short_forex', 'tag_void_yn', 'tag_table_usage',
      'amount_min', 'amount_max',
    ]),
    allowed_sorts: new Set([
      'date_trans', 'dnum_auto', 'stkcode_code',
      'location_code', 'amount_local', 'date_lastupdate',
    ]),
    allowed_groups: new Set([
      'stkcode_code', 'location_code',
      'party_code', 'party_desc',
      'staff_code', 'staff_desc',
      'tag_table_usage', 'curr_short_forex', 'date_trans',
    ]),
  },
};
